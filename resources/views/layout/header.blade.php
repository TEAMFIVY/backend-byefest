    <header class="header sticky top-0 z-30 w-full px-8 py-5 flex items-center justify-between">
        ...
        <div class="relative w-full max-w-md">
            ...
            <input type="text" placeholder="Cari data..."
                class="w-full pl-10 pr-4 py-2 rounded-full border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary-500 transition-all duration-300 shadow-sm text-slate-800">
        </div>
        <div class="flex items-center space-x-4">
            <div class="relative">
                <button
                    class="w-10 h-10 bg-white rounded-full flex items-center justify-center text-primary-600 focus:outline-none pulse">
            ...
            <div class="relative">
                ...
                <div id="dropdownMenu"
                    class="dropdown-menu absolute right-0 mt-3 w-48 bg-white rounded-xl shadow-lg z-50 py-2 hidden">
                    <a href="#"
                        class="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-100 transition-colors duration-200">
