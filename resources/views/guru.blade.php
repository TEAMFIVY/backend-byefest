    ...
    <div class="flex-1 flex flex-col min-h-screen">
        ...
        <main class="flex-1 p-8">
            ...
            <div class="flex justify-end mb-6" data-aos="fade-up" data-aos-delay="100">
                <button id="addGuruBtn"
                    class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-6 rounded-xl shadow-lg transition duration-200">
    ...
    <div id="guruModal" class="modal fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
        <div class="modal-content bg-white p-8 rounded-2xl shadow-xl w-full max-w-lg mx-4">
            <div class="flex justify-between items-center mb-6">
                ...
                <button onclick="closeModal('guruModal')"
            ...
            <form id="guruForm">
                ...
                <div class="flex justify-end space-x-4">
                    <button type="button" onclick="closeModal('guruModal')"
                        class="px-6 py-2 rounded-lg text-gray-600 hover:bg-gray-200 transition duration-200">Batal</button>
                    <button type="submit"
                        class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-6 rounded-lg transition duration-200">Simpan</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="deleteModal"
        ...
        <div class="modal-content bg-white p-8 rounded-2xl shadow-xl w-full max-w-sm mx-4 text-center">
            <div class="flex flex-col items-center justify-center mb-6">
                <div
                    class="w-16 h-16 rounded-full bg-red-100 flex items-center justify-center text-red-600 text-3xl mb-4">
                    <i class="bi bi-trash-fill"></i>
                </div>
                <h3 class="text-xl font-bold text-gray-800 mb-2">Hapus Guru</h3>
                <p class="text-sm text-gray-500">Apakah Anda yakin ingin menghapus data guru ini? Aksi ini tidak dapat
                    dibatalkan.</p>
            </div>
            <div class="flex justify-center space-x-4">
                ...
                <button type="button" id="confirmDeleteBtn"
                    class="bg-red-600 hover:bg-red-700 text-white font-semibold py-2 px-6 rounded-lg transition duration-200">Hapus</button>
            </div>
        </div>
    </div>
