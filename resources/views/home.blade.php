...
<body class="flex relative overflow-x-hidden min-h-screen">
    ...
    <div class="flex-1 flex flex-col min-h-screen ">
        ...
        <main class="flex-1 p-8">
            <h2 class="text-2xl font-semibold mb-8 text-slate-800 font-display" data-aos="fade-up">📊 Dashboard Overview
            </h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div class="card p-6" data-aos="fade-up" data-aos-delay="500">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <button
                            class="text-xs text-primary-600 font-medium hover:text-primary-700 transition-colors duration-200">
                            Lihat Semua
                        </button>
                    </div>
                    <div class="space-y-5">
                        <div class="flex items-start" data-aos="fade-up" data-aos-delay="550">
                            <div
                                class="w-12 h-12 rounded-xl bg-indigo-100 flex items-center justify-center text-indigo-600 mr-4">
                        ...
                        <div class="flex items-start" data-aos="fade-up" data-aos-delay="600">
                            <div
                                class="w-12 h-12 rounded-xl bg-amber-100 flex items-center justify-center text-amber-600 mr-4">
                                <i class="bi bi-pencil-square"></i>
                            </div>
                            <div class="flex-1">
    ...
    <script>
        ...
        setTimeout(() => {
            drawMiniChart('siswaChart', '#4f46e5', [30, 45, 25, 60, 50, 70, 65, 75, 60, 40, 50, 55, 65, 70, 75,
                80
            ]);
            drawMiniChart('guruChart', '#10b981', [40, 35, 50, 45, 40, 55, 40, 35, 30, 40, 45, 50, 55, 50, 45,
                50
            ]);
            drawMiniChart('tryoutChart', '#f59e0b', [60, 65, 70, 60, 55, 50, 45, 55, 60, 65, 70, 75, 70, 65, 70,
                75
            ]);
            drawMiniChart('aktivitasChart', '#8b5cf6', [20, 25, 30, 40, 35, 45, 50, 55, 50, 45, 40, 35, 40, 45,
                50, 55
            ]);
        }, 800);
